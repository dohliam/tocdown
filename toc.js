function md2Toc() {
  ...
  for(var i=0;i < input_array.length;i++) {
    ...
    if (hashcheck.test(line)) {
      ...
      var href = title.replace(/ /g, "-").replace(nonTocCharactersRegex, "").toLowerCase();
